...
pd.DataFrame(np.transpose(np.transpose(o2)/volume)).to_csv("D:/bensd/Documents/RStudio Workspace/1D-AEM-py/model_output/model_o2_output.csv")
pd.DataFrame(np.transpose(np.transpose(temp))).to_csv("D:/bensd/Documents/RStudio Workspace/1D-AEM-py/model_output/model_temp_output.csv")