...
## lake configurations
zmax = 7  # maximum lake depth
nx = 7 * 2 # number of layers we will have
dt = 3600 # 24 hours times 60 min/hour times 60 seconds/min
dx = zmax/nx # spatial step

## area and depth values of our lake 
area, depth, volume = get_hypsography(hypsofile = '../../lakes/troutbog/bathymetry.csv',
                            dx = dx, nx = nx)
                           
## atmospheric boundary conditions
meteo_all = provide_meteorology(meteofile = '../../lakes/troutbog/meteodriverdata.csv',
                    secchifile = None, 
                    windfactor = 1.0)
...
total_runtime =  (365 * 3) * hydrodynamic_timestep/dt  #365 *1 # 14 * 365  (365 *1.7) 
...
thermocline_dep = thermo_dep[0,:]
plt.plot(times, depth[thermocline_dep.astype(int)])
plt.show()
